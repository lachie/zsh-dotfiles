path=( /usr/local/go/bin $HOME/dev/blake/go/bin /usr/local/heroku/bin /usr/local/share/npm/bin $HOME/bin $HOME/Dropbox/Blake/sync/bin /usr/local/bin /usr/local/sbin /usr/local/flex/bin  $path )
